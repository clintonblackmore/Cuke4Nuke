...
public class JsonMapper {
	...
	public static string ToJson(object obj, JsonOptions options = JsonOptions.None) {
		return ToJson(obj, new JsonWriter(options));
	}
	...
	public static T ToObject<T>(string json, JsonOptions options = JsonOptions.None) {
		JsonReader reader = new JsonReader(json, options);
		return (T)ReadValue(typeof(T), reader);
	}
