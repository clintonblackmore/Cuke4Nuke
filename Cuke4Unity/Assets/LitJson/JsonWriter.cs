...
public class JsonWriter {
	...
	public JsonWriter(LitJson.JsonOptions options)
	: this()
	{
		if (((int)options & (int)LitJson.JsonOptions.UseTypeHinting) != 0)
		{
			TypeHinting = true;
		}
		if (((int)options & (int)LitJson.JsonOptions.PrettyPrint) != 0)
		{
			PrettyPrint = true;
		}
	}
